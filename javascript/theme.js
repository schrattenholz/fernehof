  ...
  const theme = {
    ...
    */
    ...
    init: () => {
      ...
      theme.charts();
	  theme.callToActions();
	  theme.clickableParent();
    },
    /**
     * CallToActions from SolaSoft
     * @memberof theme
     * @method calltoactions
    */
    callToActions: () => {

      let calltoactions = document.querySelectorAll('#calltoactions');

      if (calltoactions === null) return;
...
/**
     * Make ParentMenuButton clickable from SolaSoft
     * @memberof theme
     * @method clickableparent
    */
    clickableParent: () => {

      let clickableparent = document.querySelectorAll('.dropdown > a');

      if (clickableparent === null) return;
