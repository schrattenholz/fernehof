<div  class=" colorSet{$ColorSetID} py-5 container-fluid px-0">
    ...
    <section class="row no-gutters ">
			...
			<div class="col-md-6 bg-position-center bg-size-cover <% if $ImageLeft %>order-md-2<% else %>order-md-1<% end_if %>">
				...
				<div class="col-md-6 bg-position-center bg-size-cover bg-secondary <% if $ImageLeft %>order-md-1<% else %>order-md-2<% end_if %>" style="min-height: 15rem; background-image: url($Image.ScaleWidth(800).URL);">
